...
George Hotz 在 discord 说对于一代硬件的软件支持，至少还会持续一年（~ 2020-10-10），也就是说，即使你现在购买了一代硬件，也是可以继续使用的，并且可以得到官方软件的支持。

### 怎么买，从哪买

目前，官方已经下架了一代硬件，全面销售二代硬件，但是国内仍然有商家在卖一代硬件，同时跟进研发类似功能的新硬件。
...
总结：相比 Plan A，再购买一个专业的散热支架套件（含风扇、Gopro底座）是非常有必要的，因为 openpilot 的运算量较大，在夏天高温环境下，容易导致 EON 因为温度过高而不能正常工作，散热套件加持，可以一年四季长时间使用。
...
商品|花费|购买途径
-|-|-
官方 Harness 套件<br>（含 Black Panda、Harness connector）|  $399 (套件) + $30（运费）<br>+ 400（关税 + DHL服务费）| 官方 
二手 乐视 3 pro 手机|  300 RMB | 二手闲鱼 
散热支架套件|  700 RMB | 国内商家 

总价：~ 4400 RMB

总结：买新不买旧，适合入手第一套的朋友，相比国产版本的一代，确实多花了一些钱，但是可以体验到自动切换，可以隐藏安装，也不用担心未来软件版本的兼容性。
...
-|-|-
官方 Harness 套件<br>（含 Black Panda、Harness connector）|  $399 (套件) + $30（运费）<br>+ 400（关税 + DHL服务费）| 官方 
官方 EON 套件<br>（含 散热壳、乐视 3 pro 手机）|  $599 (套件) + $30（运费）<br>+ 600（关税 + DHL服务费）| 官方 

总价：~ 8000 RMB

总结：官方全能套件，好用没得说，支持正版，纳税光荣！
